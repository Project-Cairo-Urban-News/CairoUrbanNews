            ...
            <text xml:lang="ar" resp="#eAM">
                <body>
                    ...
                    <list>
                        ...
                        <xsl:for-each-group select="$articlesAr//orgName[@type]" group-by="@type">
                            ...
                            <item xml:lang="ar" xml:id="{concat('orgType_', generate-id())}">
                                ...
                                <note>
                                    <xsl:for-each select="$articlesAr//div[.//orgName[@type = current-grouping-key()]]/date[@when-custom]">
                                    ...
                                    <xsl:for-each select="$articlesAr//div[.//orgName[@type = current-grouping-key()]]/head/date[@when-custom]">
                                        <date when-custom="{@when-custom}">
                                            <xsl:value-of select="."/>
