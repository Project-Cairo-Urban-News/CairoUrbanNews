    ...
    <xsl:template match="/" name="xsl:initial-template">
        ...
        <TEI>
            <teiHeader>
                <fileDesc>
                    <titleStmt>
                        <title>PlaceName Types in the Dataset - "Urbanism News In The Official Egyptian Gazette (al-Waqāʾiʿ
            ...
            <text xml:lang="ota" resp="#eAM">
                <body>
                    ...
                    <list>
                        ...
                        <xsl:for-each-group select="$articlesOta//placeName[@type]" group-by="@type">
                            ...
                            <item xml:lang="ota" xml:id="{concat('placeType_', generate-id())}">
                                ...
                                <note>
                                    <xsl:for-each select="$articlesOta//div[.//placeName[@type = current-grouping-key()]]/date[@when-custom]">
                                    ...
                                    <xsl:for-each select="$articlesOta//div[.//placeName[@type = current-grouping-key()]]/head/date[@when-custom]">
                                        <date when-custom="{@when-custom}">
                                            <xsl:value-of select="."/>
